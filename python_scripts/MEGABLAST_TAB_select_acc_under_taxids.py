...
parser.add_argument("-j", "--taxidacc_in_f", dest='taxidacc_in_f',
                    help="[optional if --acc_out_f provided] Output tabular (tsv) file with taxid and accession numbers from krona_taxid_acc_f found under taxid in ncbi taxonomy tree",
                    metavar="FILE")
...
parser.add_argument("-p", "--taxidacc_out_f", dest='taxidacc_out_f',
                    help="[optional if --acc_in_f provided] Output tabular (tsv) file with taxid and accession numbers from krona_taxid_acc_f NOT found under taxid in ncbi taxonomy tree",
                    metavar="FILE")
